...
var arr = [
    {statement: "The courses was outstanding and advanced everything i needed to know about", name:"Sumit agrawal", passion:"web developer", photo:"./img/sumit.jpg"},
...
function Coursecard(){
    ...
    var arr2 = [
        {pic:"./img/sumit.jpg", course:"Web Developer", mentor:"./img/sumit.jpg",  name:"Sumit Agrawal"},
